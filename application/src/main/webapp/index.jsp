...
<%@ page import="x.org.apache.chemistry.opencmis.fileshare.*" %>
...
<p>Only Browser Binding is enabled. Authentication is OAuth 2.0 (Bearer Token). </p>

<h2>Access Information</h2>

<h3>CMIS 1.1</h3>

<p><s>Web Services Binding: WSDL</s></p>
<p><s>AtomPub Binding: Service Document</s></p>
<p>Browser Binding: <a href="browser">Service Document</a> (authorization required)</p>
...
<tr><td>key_user</td></tr>
<tr><td>end_user</td></tr>
</table>
